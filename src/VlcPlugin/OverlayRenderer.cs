...
public class OverlayRenderer : IDisposable
{
    ...
    public OverlayRenderer()
    {
        ...
        Console.Error.WriteLine($"[VlcPlugin] OverlayRenderer created: {OverlayWidth}x{OverlayHeight}, font loaded");
    }

    private Font LoadEmbeddedFont()
    {
        var assembly = Assembly.GetExecutingAssembly();
        var resourceName = "VlcPlugin.Resources.JetBrainsMono-Regular.ttf";
        ...
        if (stream == null)
        {
            ...
            Console.Error.WriteLine($"[VlcPlugin] Available resources: {string.Join(", ", resources)}");
